...
void ConflictGeneratorSetup::init_default() {
    ...
    config_sample_dir = testing_path + "/arc/config.50";
...
/**
* Return an row, first column=symbol name, second and third column is the value of the symbol
*/
