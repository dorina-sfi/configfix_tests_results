...
void ConflictFrameworkSetup::init_default() {
    ...
    config_sample_dir = testing_path + "/alpha/config.50";
...
/**
 * Initializing default or console values
 */
...
/**
 * Mode 3: Generates configuration and conflicts for a list of architecture
 */
